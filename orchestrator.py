...
from new_agents.research_agent.research_agent import researcher_agent
import asyncio
...
writer_agent = Agent(
    ...
    tools=[
        researcher_agent.as_tool(
            tool_name = "data_engineer_researcher_agent",
            tool_description=""" 
...
async def main():
    result = await Runner.run(
        writer_agent,
        "Find the latest content on data engineering careers, big tech culture, and technical growth."
